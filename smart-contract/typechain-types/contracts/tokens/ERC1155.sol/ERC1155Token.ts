...
export interface ERC1155TokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "mintBatch(uint256[],uint256[],uint256,bytes)"
      | "owner"
      | "renounceOwnership"
  ...
  encodeFunctionData(
    functionFragment: "mint(uint256,uint256,uint256,bytes)",
  ...
  encodeFunctionData(
    functionFragment: "mintBatch(uint256[],uint256[],uint256,bytes)",
    values: [BigNumberish[], BigNumberish[], BigNumberish, BytesLike]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "verifyMintBatchSig",
    values: [
      AddressLike,
      BigNumberish[],
      BigNumberish[],
  ...
  encodeFunctionData(
    functionFragment: "verifyMintSig",
    values: [
      AddressLike,
      BigNumberish,
      BigNumberish,
...
export namespace SignerSetEvent {
  export type InputTuple = [signer: AddressLike, oldSigner: AddressLike];
  export type OutputTuple = [signer: string, oldSigner: string];
  export interface OutputObject {
    signer: string;
    oldSigner: string;
  }
...
export interface ERC1155Token extends BaseContract {
  ...
  "mint(uint256,uint256,uint256,bytes)": TypedContractMethod<
    [
  ...
  "mintBatch(uint256[],uint256[],uint256,bytes)": TypedContractMethod<
    [
      tokenIds: BigNumberish[],
      amounts: BigNumberish[],
      deadline: BigNumberish,
  ...
  verifyMintBatchSig: TypedContractMethod<
    [
      account: AddressLike,
      tokenIds: BigNumberish[],
      amounts: BigNumberish[],
  ...
  verifyMintSig: TypedContractMethod<
    [
      account: AddressLike,
      tokenId: BigNumberish,
      amount: BigNumberish,
  ...
  >;
  getFunction(
    nameOrSignature: "mint(uint256,uint256,uint256,bytes)"
  ): TypedContractMethod<
    [
      tokenId: BigNumberish,
      amount: BigNumberish,
  ...
  >;
  getFunction(
    nameOrSignature: "mintBatch(uint256[],uint256[],uint256,bytes)"
  ): TypedContractMethod<
    [
      tokenIds: BigNumberish[],
      amounts: BigNumberish[],
  ...
  getFunction(
    nameOrSignature: "verifyMintBatchSig"
  ): TypedContractMethod<
    [
      account: AddressLike,
      tokenIds: BigNumberish[],
  ...
  filters: {
    ...
    "SignerSet(address,address)": TypedContractEvent<
      SignerSetEvent.InputTuple,
      SignerSetEvent.OutputTuple,
      SignerSetEvent.OutputObject
    >;
